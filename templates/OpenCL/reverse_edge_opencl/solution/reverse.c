...
int main(int argc, char *argv[])
{
    ...
    err = getCLKernel(ctxt, "reverse.cl", "reverse2d", &kernel);
    //err = getCLKernel(ctxt, "reverse.cl", "reverse1d_col", &kernel);
    //err = getCLKernel(ctxt, "reverse.cl", "reverse1d_row", &kernel);
